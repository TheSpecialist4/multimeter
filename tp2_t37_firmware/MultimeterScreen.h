...
class MultimeterScreen
{
  ...
  public:
    ...
    void displaySample(Typed_Sample_t sample);

    void displaySampleMode(uint8_t sample_mode);

    void displaySampleRate(unsigned long sample_period);

    void displayBrightness(uint8_t brightness);

    void setLoggingConfigMode(uint8_t sample_mode, unsigned long sample_period);
};
